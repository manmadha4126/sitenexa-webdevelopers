            ...
            <div className="grid lg:grid-cols-2 gap-6 items-start">
              <div>
                ...
                <div className="gap-3 flex-row flex items-start justify-start">
                  ...
                  <a href="#" className="w-[44px] h-[44px] rounded-full bg-[hsl(145,60%,42%)] flex items-center justify-center text-white hover:scale-110 transition-transform shadow-lg">
                    <MapPin size={18} />
                  </a>
                  <a href="https://wa.me/918074666415" target="_blank" rel="noopener noreferrer" className="w-[44px] h-[44px] rounded-full bg-[hsl(135,70%,40%)] flex items-center justify-center text-white hover:scale-110 transition-transform shadow-lg">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                  ...
                  <a href="tel:+918074666415" className="w-[44px] h-[44px] rounded-full bg-[hsl(215,75%,52%)] flex items-center justify-center text-white hover:scale-110 transition-transform shadow-lg">
                    <Phone size={18} />
                  </a>
                </div>
              </div>
