    ...
    <section id="contact" className="py-10 lg:py-14 bg-white" ref={ref}>
      <div className="container">
        <div
          ...
          {/* Top dark section - decreased height */}
          <div className="bg-[hsl(240,22%,13%)] px-8 lg:px-[50px] pt-8 pb-8">
            <div className="grid lg:grid-cols-2 gap-8 items-start">
              ...
              <div>
                ...
                <h2 className="text-[2rem] lg:text-[2.4rem] tracking-tight leading-[1.12] text-white mb-6 font-semibold font-serif">
                  Connect with Us for
                  the Best & Perfect{" "}
                ...
                {/* Social icons */}
                <div className="gap-3.5 flex-row flex items-start justify-start">
          ...
          {/* Bottom light section - increased height for contact details */}
          <div className="bg-[hsl(230,25%,94%)] px-8 lg:px-14 pt-14 pb-14">
